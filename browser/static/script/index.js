    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ${
                      browserList.includes(info.browser)
                        ? `<img src="static/image/browser/${info.browser}.png" width="24" height="24"/>`
                        : ""
                    }
                    <strong>${
                      info.browser ||
                      '<img src="static/image/loading.gif" width="32" height="32"/>'
                    }</strong>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    ${
                      systemList.includes(info.system)
                        ? `<img src="static/image/system/${
                            systemMap[system] || info.system
                          }.png" width="24" height="24"/>`
                        : ""
                    }
                    <span>${info.system} ${info.systemVersion} (${
    info.bitness
  }位)</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <span>${
                      info.screenPixelDepth
                        ? info.screenPixelDepth + "-bit"
                        : ""
                    }</span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>${
                  info.isOnline
                    ? '是 <span class="text-gray">(true)</span>'
                    : '否 <span class="text-gray">(false)</span>'
                }</td>
            </tr>
            <tr>
                <td class="th">
